...
const groups = [
  {
    title: "校内协同",
    items: [
      { icon: "👨‍🏫", label: "班主任任务", right: "12 项进行中", to: "/school/intasks" as const },
      { icon: "🏥", label: "校医任务", right: "3 项待处理", to: "/school/intasks" as const },
      { icon: "⚽", label: "体育老师任务", right: "5 项", to: "/school/intasks" as const },
      { icon: "🍱", label: "食堂 / 后勤（P1）", right: "计划中", to: "/school/intasks" as const },
      { icon: "🚨", label: "异常上报", right: "3 步流转", to: "/school/abnormal" as const },
      { icon: "📈", label: "学生变化观察", right: "查看趋势", to: "/school/observe" as const },
    ],
  },
  {
    title: "报告与家长",
    items: [
      { icon: "📊", label: "报告中心", right: "89 家长未读", to: "/school/report" as const },
      { icon: "📩", label: "家长通知与授权", right: "18 未授权", to: "/school/notify" as const },
      { icon: "🏥", label: "缺检与补检", right: "4 待安排", to: "/school/absent" as const },
    ],
  },
  {
    title: "账号与说明",
    items: [
      { icon: "🏫", label: "当前学校", right: "阳光小学" },
      { icon: "👤", label: "当前角色", right: "卫生保健老师" },
      { icon: "🔔", label: "消息通知", right: "5 条未读" },
      { icon: "📜", label: "操作记录", right: "" },
      { icon: "🔒", label: "权限说明", right: "看任务不看隐私" },
