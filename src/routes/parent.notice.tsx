    ...
    items: [
      {
        ...
        icon: "🚫",
        title: "检前禁食禁水",
        desc: "体检前一晚 22:00 后禁食禁水（含牛奶、饮料），次日晨起空腹到校，避免影响血糖 / 腹部超声结果。",
        status: "已阅读",
      ...
      },
      {
        ...
        icon: "😴",
        title: "充足睡眠 · 避免剧烈运动",
        desc: "检前一晚 21:30 前入睡，当日勿跑跳追逐，静息 10 分钟后再测血压 / 心率，结果更准确。",
        status: "已阅读",
      ...
      },
      {
        ...
        icon: "🥗",
        title: "前 3 天清淡饮食",
        desc: "避免油炸、烧烤、高糖饮料及保健品；勿服用维生素 C / 布洛芬等可能干扰化验的药物（长期用药请提前告知校医）。",
        status: "已阅读",
        deadline: "2026-04-12 起执行",
      },
      {
        id: "wear",
        icon: "👕",
        title: "着装与随身物品",
        desc: "穿宽松易穿脱的衣物与运动鞋，女生勿穿连体衣 / 连裤袜；佩戴眼镜的孩子请携带眼镜。",
        status: "已阅读",
        deadline: "2026-04-15 当日",
      },
      {
        id: "sick",
        icon: "🤒",
        title: "身体不适需请假",
        desc: "如出现发热（≥37.3℃）、咳嗽、腹泻或女生月经期等情况，请提前在「我的-请假」中报备，安排补检。",
        status: "已阅读",
        deadline: "如有情况即时告知",
      },
      {
